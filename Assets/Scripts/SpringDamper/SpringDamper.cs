...
namespace Common.SpringDamper
{
    ...
    public class SpringDamper
    {
        ...
        /// <returns></returns>
        public static float damper_exact(float x, float g, float halflife, float dt, float eps = 1e-5f)
        {
        ...
        /// <param name="eps"></param>
        public static void spring_damper_exact(
            float x,
            float v,
            float x_goal,
            float v_goal,
        ...
        /// <param name="v_accumulated"></param>
        /// <param name="eps"></param>
        public static void spring_damper_exact_ratio(
            float x,
            float v,
            float x_goal,
            float v_goal,
        ...
        /// <param name="halflife"></param>
        /// <param name="dt"></param>
        public static void simple_spring_damper_exact_quat(
            Quaternion x,
            Vector3 v,
            Quaternion x_goal,
            float halflife,
